...
export default function DashboardPage() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto">
      ...
      <Card className="bg-white dark:bg-card rounded-2xl p-5 sm:p-6 shadow-sm border">
        {/* Filter Bar */}
        ...
        {filteredTransactions.length > 0 ? (
          <div className="border rounded-lg overflow-hidden max-h-[400px] flex flex-col">
            {/* Table Header - Sticky */}
            <div className="grid grid-cols-4 gap-4 p-4 bg-muted/50 border-b font-medium text-sm sticky top-0 z-10">
              <div>Transaction</div>
              <div>Type</div>
              <div>Date</div>
